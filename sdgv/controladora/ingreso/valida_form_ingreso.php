...
if ($num_rows > 0) {
    ...
    if ($row["rol_id"] == 1) {
        //cliente
        header("Location: ../../paginas/inicio/cliente_inicio.php");
        exit();
    } elseif ($row["rol_id"] == 2) {
        //jefe de catedra
        header("Location: ../../paginas/inicio/jefecatedra_inicio.php");
        exit();
    } elseif ($row["rol_id"] == 3) {
        //admin
    ...
    <body>
        ...
        <div class="row d-flex-row justify-content-center pt-2">
            <h2 class="errorBackend">Email o Contraseña incorrectos, pruebe de nuevo. <br>
                <a href="../../paginas/ingreso/ingreso.php" type="submit" class="btn btn-light">Ir al Ingreso</a><br> <br>
            </h2>
        </div>
