            ...
            <form method="POST" class="d-flex flex-column iniciosesion">
                <div class="d-flex justify-content-between formdiv m-2">
                    ...
                    <div class="containerError">
                        <input class="px-3" type="text" name="Nom" placeholder="Ingrese su nombre..." required onchange="validaSoloLetras(this)"/>
                ...
                <label class="formlabel" for="">Apellido:</label>
                    <div class="containerError">
                        <input class="px-3" type="text" name="Ape" placeholder="Ingrese su apellido..." required onchange="validaSoloLetras(this)"/>
