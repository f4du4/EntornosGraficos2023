    ...
    <div class="container-fluid d-flex-row m-0">
        ...
        ?>
                <div class="row d-flex d-flex-row justify-content-center pt-2">
                    ...
                    <form action="../../controladora/postulaciones/procesar_enviar_postulacion.php" class="d-flex flex-column justify-content-center text-center inicio" method="post" enctype="multipart/form-data">
