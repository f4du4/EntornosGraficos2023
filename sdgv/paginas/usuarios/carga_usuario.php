            ...
            <form method="POST" class="d-flex flex-column iniciosesion">
                <div class="d-flex justify-content-between formdiv m-2">
                    ...
                    <div class="containerError">
                        <input class="px-3" type="text" name="Nom" placeholder="Ingrese nombre..." required onchange="validaSoloLetras(this)" autocomplete="one-time-code" />
                ...
                <div class="d-flex justify-content-between formdiv m-2">
                    ...
                    <div class="containerError">
                        <input class="px-3" type="text" name="Ape" placeholder="Ingrese apellido..." required onchange="validaSoloLetras(this)" autocomplete="one-time-code" />
                        <div class="error hidden">Apellido invalido: solo ingresar letras</div>
                    </div>
                </div>
                <div class="d-flex justify-content-between formdiv m-2">
                    <label class="formlabel" for="">Email:</label>
                    <input class="px-3" type="email" name="Mail" placeholder="Ingrese email..." required autocomplete="one-time-code" />
                </div>
