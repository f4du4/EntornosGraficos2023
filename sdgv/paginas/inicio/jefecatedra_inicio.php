...
<body>
    <div class="container-fluid d-flex-row m-0">
        ...
        <div class="row d-flex-row justify-content-center pt-2">
            ...
            <img src="../../imagenes/mapas/mapasitio_jefecatedra.png" alt="Mapa de Sitio del Sitio Web de Gestion de Vacantes de la UTN FRRo para Jefes de Catedra" class="mapasitio" />
        </div>
