    ...
    <div class="container-fluid d-flex-row m-0">
        ...
        <div class="row d-flex-row justify-content-center pt-2">
            ...
            <p class="inicio descripcion p-3 text-center">La universidad Tecnológica Nacional de Rosario se encuentra ubicada en el centro de la ciudad de Rosario,
                con direccion en Zeballos 1341, fue fundada en 1953 y actualmente consta de cinco carreras de grado. <br>
                <br>
            ...
            <img src="../../imagenes/mapas/mapasitio_usuarios_no_logueados.png" alt="Mapa de Sitio del Sitio Web de Gestion de Vacantes de la UTN FRRo" class="mapasitio">
        </div>
