...
<div class="row d-flex-row justify-content-center pt-2">
    <h2 class="text-center p-4 pt-3 titulo">¡Notificacion enviada exitosamente!</h2><br>
    <a href="\jefecatedra_vacantes.php" type="submit" name="submitingreso" class="mt-4 mb-5 p-2 btn btn-success exito">Volver Atras</a><br><br>
</div>
    <?php
        include "./footer.html";
    ?>
